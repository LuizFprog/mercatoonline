...
async function main() {
  ...
  try {
    ...
    console.log(`Encontrados ${statesData.length} registros de estados.`);
  ...
  try {
    ...
    console.log(`Encontrados ${citiesData.length} registros de cidades.`);
  ...
  console.log(`\nPovoamento (seeding) finalizado com sucesso.`);
}

main().catch((e) => {
  console.error('\nO processo de seeding falhou. Veja os erros acima.');
  process.exit(1);
